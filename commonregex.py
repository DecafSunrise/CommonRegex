...
hashtag          = re.compile(r'\B#\w*[a-zA-Z0-9!-\/\:-@\[-`{-~]+') # Still a WIP, trying to add symbol support
atUsername       = re.compile(r'\B@\w*[a-zA-Z0-9!-\/\:-@\[-`{-~]+') # Still a WIP, trying to add symbol support
